...
import spring.cloud.account.config.interceptors.GlobalAspectInterceptor;
...
public class GlobalBeanConfig {
    ...
    public GlobalAspectInterceptor getLoggerInterceptor() {
        return new GlobalAspectInterceptor();
    }
